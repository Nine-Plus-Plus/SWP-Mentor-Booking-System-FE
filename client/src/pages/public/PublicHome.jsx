    ...
    return (
        <div className="flex flex-col items-center justify-center h-min-heigh-custom">
            <header className="text-center my-8">
                <h1 className="text-4xl font-bold text-main-1">
                    Welcome to the Booking Mentor System
                </h1>
                <p className="mt-4 text-lg text-gray-600">
                    Find the right mentor for your project
                </p>
            </header>
            <section className="text-center mt-12">
                <div className="mb-8">
                    ...
                    <p className="mt-4 text-gray-600 max-w-md mx-auto">
                        Our system allows students to create groups, search for mentors
                        based on their skills, and book sessions for guidance. Mentors can
                        manage their availability and provide support in various domains.
                    </p>
                </div>
