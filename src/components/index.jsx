...
export { default as ChangePass } from './login/ChangePass';
export { default as ForgotPass } from './login/ForgotPass';
...
// mentor
export { default as Schedule } from './mentor/Schedule';
// admin
...
export { default as GroupManager } from './admin/GroupManager';
